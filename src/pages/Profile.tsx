...
import { User, Mail, Lock, Save, Loader as Loader2, CircleUser as UserCircle, Eye, EyeOff } from "lucide-react";
        ...
        <div className="md:col-span-2 space-y-8">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Nova Senha (mínimo 7 caracteres)</label>
                  <div className="relative">
                    <input
                      type={showPassword ? "text" : "password"}
                      required
                      minLength={7}
                      className="block w-full px-3 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm"
                      placeholder="••••••••"
                      value={password}
